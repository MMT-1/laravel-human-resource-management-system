                                            ...
                                            <td class="text-center">
                                                <div class="dropdown action-label">
                                                    ...
                                                    @if (Auth::user()->role_name == 'Admin')
                                                        ...
                                                        <!-- Approve link -->
                                                            <form action="{{ route('leave.approve', $items->id) }}" method="POST">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item"><i class="fa fa-dot-circle-o text-success"></i> Approve</button>
                                                            </form>

                                                            <!-- Decline link -->
                                                            <form action="{{ route('leave.decline', $items->id) }}" method="POST">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item"><i class="fa fa-dot-circle-o text-danger"></i> Decline</button>
                                                            </form>

                                                            <!-- Pending link -->
                                                            <form action="{{ route('leave.pending', $items->id) }}" method="POST">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item"><i class="fa fa-dot-circle-o text-danger"></i> Pending</button>
                                                            </form>
                                                    @endif
